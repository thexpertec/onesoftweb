...
const row2: FeatureItem[] = [
  ...
  { Icon: FileCheck,     label: "VAT Returns",             color: "#f59e0b" },
  { Icon: Building,      label: "Corporation Tax",         color: "#06b6d4" },
  { Icon: FileText,      label: "Self Assessment",         color: "#ec4899" },
  { Icon: ClipboardCheck,label: "HMRC MTD",                color: "#14b8a6" },
...
const row3: FeatureItem[] = [
  ...
  { Icon: BadgeCheck,    label: "PAYE & NI",               color: "#3b82f6" },
  { Icon: Heart,         label: "Pension Auto-Enrol",      color: "#8b5cf6" },
