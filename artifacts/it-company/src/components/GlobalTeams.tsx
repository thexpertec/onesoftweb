...
const members: Member[] = [
  { name: "Ahmed Raza",         role: "Head of Engineering",   photo: pk1,  flag: "🇵🇰", accent: "#4FC6FF" },
  { name: "Sara Malik",         role: "Lead UX Designer",      photo: pk2,  flag: "🇵🇰", accent: "#4FC6FF" },
  { name: "Tariq Hassan",       role: "Senior Backend Dev",    photo: pk3,  flag: "🇵🇰", accent: "#4FC6FF" },
  { name: "Usman Farooq",       role: "ERP Implementation",    photo: pk4,  flag: "🇵🇰", accent: "#4FC6FF" },
  { name: "Bilal Chaudhry",     role: "Mobile Developer",      photo: pk5,  flag: "🇵🇰", accent: "#4FC6FF" },
  { name: "Ayesha Siddiqui",    role: "Project Coordinator",   photo: pk6,  flag: "🇵🇰", accent: "#4FC6FF" },
  { name: "Hamza Nawaz",        role: "DevOps Engineer",       photo: pk7,  flag: "🇵🇰", accent: "#4FC6FF" },
  { name: "Zainab Qureshi",     role: "Business Analyst",      photo: pk8,  flag: "🇵🇰", accent: "#4FC6FF" },
  { name: "Faisal Mehmood",     role: "Database Architect",    photo: pk9,  flag: "🇵🇰", accent: "#4FC6FF" },
