...
const row1: Client[] = [
  { domain: "nandos.co.uk",       name: "Nando's",          sector: "Restaurant",   flag: "🇬🇧", color: "#dc2626" },
  ...
  { domain: "dunkin.com",         name: "Dunkin'",           sector: "Café",         flag: "🇺🇸", color: "#ea580c" },
  { domain: "morrisons.com",      name: "Morrisons",         sector: "Supermarket",  flag: "🇬🇧", color: "#16a34a" },
  { domain: "costcutter.com",     name: "Costcutter",        sector: "Retail",       flag: "🇬🇧", color: "#dc2626" },
];
...
const row2: Client[] = [
  ...
  { domain: "caffenero.com",          name: "Caffè Nero",        sector: "Café",         flag: "🇬🇧", color: "#292524" },
  { domain: "costacoffee.com",        name: "Costa Coffee",      sector: "Café",         flag: "🇬🇧", color: "#7f1d1d" },
  { domain: "lidl.com",               name: "Lidl",              sector: "Retail",       flag: "🌍",  color: "#2563eb" },
  { domain: "aldi.co.uk",             name: "Aldi",              sector: "Retail",       flag: "🌍",  color: "#1d4ed8" },
  { domain: "fortishealthcare.com",   name: "Fortis Healthcare", sector: "Healthcare",   flag: "🇮🇳", color: "#0891b2" },
  { domain: "metropolislab.com",      name: "Metropolis Labs",   sector: "Diagnostics",  flag: "🇮🇳", color: "#7c3aed" },
  ...
  { domain: "bupa.com",               name: "Bupa",              sector: "Healthcare",   flag: "🇬🇧", color: "#0091da" },
