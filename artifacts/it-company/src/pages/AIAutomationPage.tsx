...
const INIT_PROBLEM = {
  ...
  cards: [
    { icon: XCircle,     title: "Repetitive tasks burning your team's time",       desc: "Data entry, report generation, order confirmations, follow-up emails — your team is doing work a machine could handle, leaving no time for decisions that actually require a human." },
    { icon: AlertCircle, title: "Leads and enquiries falling through the cracks",  desc: "Without instant, intelligent responses at every touchpoint, warm leads go cold. A customer who doesn't get a reply in minutes often moves on to a competitor who does." },
    { icon: XCircle,     title: "Decisions made on gut feeling, not data",         desc: "Your systems hold enormous amounts of data — but none of it gets synthesised into actionable insight automatically. So decisions are delayed, missed, or made on yesterday's numbers." },
    { icon: AlertCircle, title: "Scaling the business means scaling headcount",    desc: "Every new customer adds proportional admin. Without automation, growth means hiring more people to do more of the same manual work — a ceiling that doesn't have to exist." },
  ],
};
...
const INIT_SOLUTION = {
  ...
  cards: [
    { icon: MessageSquare, title: "AI Chatbots & Assistants",       desc: "Conversational agents for your website, WhatsApp, and internal tools — trained on your data, available 24/7." },
    { icon: Workflow,      title: "Business Process Automation",    desc: "Map, digitise, and automate multi-step workflows across departments — approvals, notifications, escalations." },
    { icon: BrainCircuit,  title: "RAG & Knowledge Pipelines",      desc: "Connect your documents, PDFs, and databases to an LLM so staff get instant, accurate answers from your own knowledge base." },
    { icon: BarChart3,     title: "Predictive Analytics",           desc: "Demand forecasting, churn prediction, and sales projections — machine learning models built on your historical data." },
    { icon: Mail,          title: "Automated Outreach & Follow-up", desc: "Trigger personalised emails, SMS, and WhatsApp messages based on user behaviour, events, or time-based rules." },
    { icon: Search,        title: "Intelligent Document Processing",desc: "Extract, classify, and route data from invoices, forms, and contracts automatically — no manual keying." },
    { icon: GitBranch,     title: "System Integration & Webhooks",  desc: "Connect your CRM, ERP, helpdesk, and third-party APIs so data flows automatically between every tool you use." },
    { icon: RefreshCw,     title: "Scheduled & Event-Driven Jobs",  desc: "Nightly reports, real-time alerts, and triggered actions — your systems working in the background while your team sleeps." },
  ],
};
...
const INIT_TECH = {
  ...
  items: [
    { icon: BrainCircuit, label: "OpenAI & GPT-4o",           desc: "Cutting-edge language models for chat, summarisation, extraction, and generation." },
    { icon: Layers,       label: "LangChain & LlamaIndex",    desc: "Orchestration frameworks for building RAG pipelines and multi-step AI agents." },
    { icon: Database,     label: "Vector Databases",          desc: "Pinecone, Weaviate, and pgvector for semantic search and knowledge retrieval at scale." },
    { icon: Cpu,          label: "Python & FastAPI",          desc: "High-performance AI backends with clean REST APIs your existing systems can call." },
    { icon: Workflow,     label: "n8n & Make (Zapier-class)", desc: "Visual workflow automation for connecting apps without bespoke code where appropriate." },
    { icon: Shield,       label: "On-Premise Deployment",     desc: "All models and pipelines can run fully on your infrastructure — your data never leaves your control." },
  ],
};
...
const INIT_STATS = [
  { to: 70,  suffix: "%",  label: "Avg. manual task reduction" },
  { to: 24,  suffix: "/7", label: "AI availability" },
  { to: 3,   suffix: "×",  label: "Faster response times" },
  { to: 500, suffix: "+",  label: "Clients automated" },
];
...
const INIT_TESTIMONIALS = {
  ...
  items: [
    { quote: "OneSoft built us a WhatsApp chatbot for order tracking and customer queries. It now handles 80% of our support tickets with no human involvement.",            name: "Omar Farooqi",    role: "Head of Operations", co: "FastTrack Distributors" },
    { quote: "The RAG system they built means our staff can ask questions about our 400-page policy manual and get accurate answers instantly. Game-changer.",              name: "Claire Donovan",  role: "HR Director",        co: "Meridian Financial Services" },
    { quote: "Automated invoice processing cut our accounts payable workload by 65%. What took two days a week now happens overnight with zero errors.",                    name: "Yusuf Malik",     role: "CFO",                co: "Crescent Wholesale Group" },
  ],
};
...
function TechDrawer({ data, setData }: { data: typeof INIT_TECH; setData: (d: typeof INIT_TECH) => void }) {
  ...
  return (
    <div className="space-y-4">
      ...
      <EField label="Subheading" value={local.subheading} onChange={v => setLocal(d => ({ ...d, subheading: v }))} multiline />
      <ESectionHeader>Tech Items</ESectionHeader>
...
export default function AIAutomationPage() {
  ...
  return (
    <div style={{ background: pageBg, minHeight: "100vh" }}>
      ...
      {/* TECH STACK */}
      <EditableSection id="tech" label="Tech Stack" drawer={<TechDrawer data={tech} setData={setTech} />}>
