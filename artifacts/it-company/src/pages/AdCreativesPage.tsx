...
import {
  ...
  MousePointerClick, Palette, Megaphone, FileText, Globe,
} from "lucide-react";
...
const INIT_HERO = {
  badge: "Ad Creatives",
  headline: "Ad creatives that stop the scroll and drive conversions",
  subheadline: "OneSoft produces high-performance static, video, and motion ad creatives for every major platform — designed to convert, not just look good.",
  ctaPrimary: "Get a Creative Audit",
  ctaSecondary: "Book a Strategy Call",
};

const INIT_PROBLEM = {
  badge: "The Problem",
  heading: "Bad creatives are burning your ad budget",
  subheading: "The best media buying in the world can't save an ad that fails in the first two seconds.",
  cards: [
    { icon: XCircle,     title: "Ad spend wasted on creatives that don't convert", desc: "You can have the best targeting in the world — but if the creative doesn't stop the scroll in under two seconds, the money is gone. Most ads fail before they're ever seen." },
    { icon: AlertCircle, title: "Generic visuals that look like every other ad",    desc: "Stock photos, templated designs, and recycled formats have trained audiences to tune out. Your creative needs to feel fresh, native, and worth a second look every single time." },
    { icon: XCircle,     title: "No system for testing what actually works",        desc: "Without variants and A/B testing built into your creative workflow, you're guessing. Every campaign runs on hope instead of data — and performance never improves." },
    { icon: AlertCircle, title: "Creative output can't keep up with campaign demand",desc: "Running ads across Meta, Google, TikTok, and YouTube means you need dozens of formats, sizes, and variants. Most in-house teams can't produce at that volume or quality." },
  ],
};

const INIT_SOLUTION = {
  badge: "The Solution",
  heading: "Scroll-stopping creatives, built to perform",
  subheading: "Every creative we produce is briefed with a conversion goal — not just an aesthetic. Strategy, design, and copy working together.",
  cards: [
    { icon: Image,             title: "Static Ad Design",             desc: "High-conversion static creatives for Meta, Google Display, and LinkedIn — every size and placement." },
    { icon: Video,             title: "Video Ad Production",          desc: "Scroll-stopping video ads for Instagram, TikTok, YouTube, and Meta — scripted, shot, and edited." },
    { icon: Play,              title: "Motion Graphics & Reels",      desc: "Animated ads and branded Reels that feel native to the platform and designed to perform." },
    { icon: MousePointerClick, title: "Conversion-First Copywriting", desc: "Headlines, hooks, and CTAs written specifically to drive clicks — not just impressions." },
    { icon: Layers,            title: "A/B Creative Variants",        desc: "Multiple variants of every creative so you can test, learn, and scale only what works." },
    { icon: Palette,           title: "Brand-Consistent Design",      desc: "Every creative aligns with your brand identity — colour, typography, tone — across every platform." },
    { icon: Monitor,           title: "Google & Display Banners",     desc: "Full suites of HTML5-ready and static banners in all standard IAB sizes for Google Display Network." },
    { icon: FileText,          title: "Ad Creative Strategy",         desc: "We analyse your audience, funnel stage, and offer to brief creatives that align with your campaign goals." },
  ],
};

const INIT_PLATFORMS = {
  heading: "Every ad platform, covered natively",
  subheading: "We produce creatives in the correct specs, aspect ratios, and styles for each platform — not one-size-fits-all repurposing.",
  items: [
    { label: "Meta Ads",     sub: "Facebook & Instagram" },
    { label: "TikTok Ads",   sub: "Short-form video" },
    { label: "Google Ads",   sub: "Search & Display" },
    { label: "YouTube Ads",  sub: "Pre-roll & bumper ads" },
    { label: "LinkedIn Ads", sub: "B2B lead generation" },
    { label: "Snapchat Ads", sub: "Story & Discover formats" },
  ],
};

const INIT_PROCESS = {
  badge: "How It Works",
  heading: "From brief to live creative in 48 hours",
  subheading: "A structured four-step process that keeps your campaigns running at full speed — always with fresh, tested creative.",
  steps: [
...
const INIT_STATS = [
  { to: 2,   suffix: "×",          label: "Avg. CTR improvement" },
  { to: 400, suffix: "+",          label: "Campaigns produced" },
  { to: 6,   suffix: " platforms", label: "Covered natively" },
  { to: 48,  suffix: "hr",         label: "Avg. turnaround" },
];

const INIT_INDUSTRIES = {
  heading: "Creatives built for every sector",
  subheading: "We understand the audience expectations, visual conventions, and compliance requirements of your industry.",
  items: [
...
const INIT_TESTIMONIALS = {
  ...
  heading: "Creatives that move the performance needle",
  items: [
    { quote: "Our Meta Ads CTR doubled in the first month after switching to OneSoft creatives. The video ads they produce are genuinely better than anything an agency charged us 5× more for.", name: "Raza Khan",      role: "Head of Marketing",    co: "NovaBuild Properties" },
    { quote: "We went from spending £3,000 a month with nothing to show for it to a 4.2 ROAS within six weeks. The creative strategy they brought was the difference.",                         name: "Emma Clarke",    role: "E-commerce Director",  co: "Velvet & Co." },
    { quote: "They turned our product launch into a full creative campaign — static, video, stories, banners — everything matched perfectly and the results spoke for themselves.",               name: "Adnan Siddiqui", role: "Founder",              co: "SnapPack Snack Foods" },
  ],
};

const INIT_CTA = {
  badge: "Ready to scale?",
  heading: "Let's build creatives that actually convert your ad spend",
  subheading: "Free creative audit — we'll review your existing ads and tell you exactly what's costing you performance. No obligation.",
  ctaPrimary: "Get My Free Creative Audit",
            ...
            <div className="max-w-4xl mx-auto text-center">
              <motion.div initial={{ opacity: 0, y: 16 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.5 }}>
                <span className="inline-flex items-center gap-2 text-xs font-bold uppercase tracking-widest px-3 py-1.5 rounded-full mb-6"
                  style={{ background: "rgba(234,88,12,0.10)", border: "1px solid rgba(234,88,12,0.25)", color: ORANGE }}>
                  <Brush className="w-3 h-3" /> {hero.badge}
                </span>
              </motion.div>
              ...
              <motion.div initial={{ opacity: 0 }} animate={{ opacity: 1 }} transition={{ duration: 0.5, delay: 0.38 }}
                ...
                {[
                  { icon: MousePointerClick, label: "2× avg. CTR improvement" },
                  { icon: Clock,             label: "48hr avg. turnaround" },
                  { icon: Layers,            label: "A/B variants included" },
                  { icon: TrendingUp,        label: "400+ campaigns produced" },
                ].map(t => (
