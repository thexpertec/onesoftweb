      ...
      <div className="bg-white/[0.03] rounded-xl p-2.5 border border-white/8 shrink-0" style={{ width: "190px" }}>
        ...
        <div className="mt-4 pt-3 space-y-1" style={{ borderTop: "1px solid rgba(255,255,255,0.06)" }}>
          ...
          <div className="flex justify-between">
            ...
            <span className="text-[7.5px] font-bold" style={{ color: "#1E4DA0" }}>£6,840</span>
          </div>
        </div>
      </div>
      <div className="bg-white/[0.03] rounded-xl p-2.5 border border-white/8 flex-1">
            ...
            <div key={i} className="rounded-lg p-2.5 border border-white/8" style={{ background: "rgba(255,255,255,0.02)" }}>
              <div className="flex items-center justify-between mb-1.5">
                <div className="flex items-center gap-2">
                  <span className="text-[8px] font-black" style={{ color: "#1E4DA0" }}>{r.id}</span>
      ...
      <div className="flex items-center justify-between px-4 py-3 shrink-0" style={{ borderBottom: "1px solid rgba(255,255,255,0.07)" }}>
        <div className="flex items-center gap-2">
          <div className="w-6 h-6 rounded-lg flex items-center justify-center" style={{ background: "rgba(30,77,160,0.25)" }}>
            <ShoppingCart className="w-3.5 h-3.5" style={{ color: "#1E4DA0" }} />
          </div>
      ...
      <div className="relative pt-24 pb-8 md:pt-28 md:pb-10 overflow-hidden">
        ...
        <div className="container mx-auto px-4">
          <motion.div className="flex items-center gap-2 text-sm mb-8" style={{ color: t45 }}
            ...
            <ChevronRight className="w-3.5 h-3.5" />
            <span style={{ color: "#1E4DA0", fontWeight: 600 }}>E-commerce Management</span>
          </motion.div>
          ...
          <div className="max-w-4xl mx-auto text-center mb-16">
            ...
            <motion.h1 className="text-6xl md:text-8xl font-black tracking-tight mb-6 leading-[1.05]"
              ...
              Sell Everywhere.{" "}
              <span style={{ color: "#1E4DA0" }}>Manage from One Place.</span>
            </motion.h1>
                ...
                <div className="flex items-center justify-between px-5 py-4" style={{ borderBottom: `1px solid ${dividerColor}` }}>
                  <div className="flex items-center gap-2">
                    <div className="w-7 h-7 rounded-lg flex items-center justify-center" style={{ background: "rgba(30,77,160,0.15)" }}>
                      <Layers className="w-4 h-4" style={{ color: "#1E4DA0" }} />
                    </div>
        ...
        <div className="container mx-auto px-4 text-center relative">
          <motion.div initial={{ opacity: 0, y: 24 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} transition={{ duration: 0.7 }}>
            ...
            <h2 className="text-5xl md:text-6xl font-black mb-6 leading-tight">
              More channels.<br />
              <span style={{ color: "#1E4DA0" }}>Zero extra admin.</span>
            </h2>
